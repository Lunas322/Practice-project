...
function Text({text,onDelete, onDone, isDone}:TextProps) {
    return (
        <>
       <div className="bg-slate-900 w-5/6 h-1/6 rounded-xl flex p-2">
                ...
                <div id="main" onClick={onDone} className={`w-full h-full  rounded-lg p-2 text-xl font-bold flex items-center ${isDone ? "bg-green-400":"bg-slate-100"}`}>{text}</div>
